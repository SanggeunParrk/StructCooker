...
if __name__ == "__main__":
	seq_id_map_path = Path("/public_data02/BioMolDB_20260224/metadata/seq_id_map.tsv")
	old_msa_path = Path("/public_data02/old_msa/new_hash_a3m")
	new_msa_path = Path("/public_data02/msa/")	
	old_msa_db_path = Path("/public_data/BioMolDBv2_2024Oct21/a3m.lmdb")
	msa_in_db = len_lmdb(old_msa_db_path)
	num_found_in_db = num_found(old_msa_db_path)
	breakpoint()
