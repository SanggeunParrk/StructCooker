...
from structcooker.models import CIFMol, CIFMolAttached
from structcooker.constants import mol_type_map, polymer_cluster_types
from structcooker.ops.seq_instructions import extract_sequence_from_cifmol
